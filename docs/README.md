...
**WebRTC**, with STANAG 4609 (MISB 0601) KLV, **VMTI (ST 0903) moving-target** and
**ST 0102 security-marking** decoding, plus **ONVIF** LAN camera discovery.
...
| [SPASA integration](spasa-integration.md) | How SPASA Server drives the sidecar: the pull/ABR control API, `publish_protocol` (incl. `webrtc`), `webrtc_edge_base`, served-feed URL stamping, KLV→CoT, **VMTI→C2 tracks**, **ST 0102 classification**, **ONVIF onboarding**, the admin player, and the E2E rig. |
